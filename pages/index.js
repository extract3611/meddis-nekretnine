...
SliderFilterSearch.getLayout = function getLayout(page) {
  return  <Layout 
  title="Agencija za nekretnine Meddis Group - Najveći izbor nekretnina u Crnoj Gori" 
  description="Ukoliko tražite nekretninu za investiciju, stanovanje ili odmor, Meddis Group će vam pomoći da pronađete idealnu nekretninu za vaše potrebe. Dugogodišnje iskustvo i stručni tim, garantuje profesionalnu etiku i apsolutno zadovoljstvo klijenata."
>
  {page}
</Layout>;
}; 
